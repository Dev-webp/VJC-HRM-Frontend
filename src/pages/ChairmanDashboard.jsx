...
export default function ChairmanDashboard() {
  ...
  const showDesktopNotification = useCallback((data) => {
    if ('Notification' in window && Notification.permission === 'granted') {
      const notification = new Notification('🔔 New Leave Request', {
        body: `${data.employee_name || 'An employee'} has submitted a leave request`,
        icon: '/logo192.png',
        badge: '/logo192.png',
        tag: 'leave-request',
  ...
  // ✅ Toast + sound + desktop notification on new request
    ...
    <div style={styles.container}>
      ...
      <div style={styles.mainWrapper}>
        <header style={styles.header}>
          <div>
            <h2 style={styles.headerTitle}>Good Day, Dr. V. Mani 👋</h2>
            <p style={styles.headerSubtitle}>Chairman's Administrative Portal</p>
          </div>
